  ...
  <body>
    <div className="container">
      <div class="menu-box jumbotron">
        ...
        <p class="lead how-to-play-secondary"><img src={"/public/static/images/mouse.png"} alt="" /><b className="how-to-play-main">  Como jogar: </b>Aponte o mouse para os animais<br /> 
