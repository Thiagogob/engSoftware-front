...
const Home = () => (
    <div className="container">
      <div className="menu-box jumbotron">
        ...
        <p className="lead how-to-play-secondary"><img src={"/static/images/mouse.png"} alt="" /><b className="how-to-play-main">  Como jogar: </b>Aponte o mouse para os animais<br /> 
