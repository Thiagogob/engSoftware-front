        ...
        <div className="row d-flex justify-content-center">
            <div className="col-4 card-border">
                ...
                <div className="card-body card-bg">
                    ...
                    <div className="d-flex justify-content-center"><button type="button" className="btn btn-primary btn-decoration">Jogar Fase 1</button></div>
                </div>
            </div>
            ...
            <div className="col-4 card-border">
                ...
                <div className="card-body card-bg">
                    ...
                    <div className="d-flex justify-content-center"><button type="button" className="btn btn-primary btn-decoration">Jogar Fase 2</button></div>
                </div>
            </div>
        </div>
    </div>
