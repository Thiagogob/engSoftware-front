...
export const useAuth = () => {
  ...
  const loginTeacher = async (username, password) => {
    ...
    const response = await fetch(`${apiLink}/auth/teacher`, requestOptions);
  ...
  const registerTeacher = async (name, username, password) => {
    ...
    const response = await fetch(`${apiLink}/teacher`, requestOptions);
    const data = await response.json();
  ...
  const loginStudent = async (username, teacherUser) => {
    ...
    await fetch(`${apiLink}/student`, requestOptions);

    const loginResponse = await fetch(`${apiLink}/auth/student`, requestOptions);
